...
public class SAL_GUI implements EntryPoint
{
	...
	{
//		final Button Sbutton1 = new Button(new SensorConfiguration());
//		final Button Sbutton2 = new Button(new SensorConfiguration());
...
//			{
//				final Button Cbutton1 = new Button(new CommandDescription());
//				final Button Cbutton2 = new Button(new CommandDescription());
//				// denpending on the number of the commands
//				final Button Rbutton = new Button("Go");
//
//				final Label label1 = new Label(new CommandDescription());
//				final Label label2 = new Label(new CommandDescription());
//				// denpending on the number of the commands
//
...
//					{
//						label1.setText().equals(new CommandDescription());
//					}
//				}
//					
//			}
